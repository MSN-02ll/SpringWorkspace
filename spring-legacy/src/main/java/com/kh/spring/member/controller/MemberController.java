...
public class MemberController {
	 ...
	 * public String login(
	 * 
	 * @RequestParam(value="userId", defaultValue="mkm") String userId){
	 * System.out.println(userId); return "home"; }
	 */
	 ...
	 * System.out.println(userId); System.out.println(userPwd); return "home"; }
	 */
	...
	/*
	 * public String login(@ModelAttribute Member m) { System.out.println(m); return
	 * "home"; }
	 */
	...
	@PostMapping("/login")
	 public ModelAndView login(
		...
		if(loginUser != null) {
			...
			ra.addFlashAttribute("alerMsg","로그인 실패");
			/*
