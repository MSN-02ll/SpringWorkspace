	...
	<div id="header">
		<div id="header_1">
			<div id="header_1_left">
				<img
					src="https://khacademy.co.kr/resources/images/common/header/khlogo-white.svg" />
			</div>
			...
			<div id="header_1_right">
				...
				<sec:authorize access="isAuthenticated()">
					<!--
                        	...
                        	3. Credencial? (크리덴셜) : 사용자의 암호화된 "비밀번호"가 담기는 영역

                         -->
					<label><sec:authentication property="principal.userName" />님
						환영합니다.</label> &nbsp;&nbsp;
                        <a href="${contextPath }/security/myPage">마이페이지</a>

					<form:form method="post" action="${contextPath }/member/logout"
